...
var rootCmd = &cobra.Command{
	Use:   "blinkt",
	Short: "drive pimoroni blinkt led board",
...
func init() {
	...
	// rootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default is $HOME/.config/.blinkt.yaml)")
}
